...
/* harmony import */ var _modules_validateForm__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/validateForm */ "./src/js/modules/validateForm.js");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var modalState = {};
  var dedline = '2022-01-01';
  Object(_modules_validateForm__WEBPACK_IMPORTED_MODULE_6__["default"])();
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])(false);
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('.container1', dedline);
...
/* harmony import */ var _chekNumInput__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chekNumInput */ "./src/js/modules/chekNumInput.js");
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_chekNumInput__WEBPACK_IMPORTED_MODULE_1__["default"])('#height');
  Object(_chekNumInput__WEBPACK_IMPORTED_MODULE_1__["default"])('#width');
...
/***/ "./src/js/modules/chekNumInput.js":
/*!****************************************!*\
  !*** ./src/js/modules/chekNumInput.js ***!
  \****************************************/
/*! exports provided: default */
...
var chekNumInput = function chekNumInput(select) {
  var inputSel = document.querySelectorAll(select);
  inputSel.forEach(function (item) {
...
/* harmony default export */ __webpack_exports__["default"] = (chekNumInput);
...
/* harmony import */ var _chekNumInput__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./chekNumInput */ "./src/js/modules/chekNumInput.js");
...
var forms = function forms(state) {
  ...
  Object(_chekNumInput__WEBPACK_IMPORTED_MODULE_6__["default"])('input[name="user_phone"]');
  var messages = {
    loading: 'Загрузка...',
  ...
  var bindForm = function bindForm(url, data) {
    var res;
    return regeneratorRuntime.async(function bindForm$(_context) {
      while (1) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      bindForm('assets/server.php', formData).then(function (res) {
        console.log(res);
...
var images = function images() {
  var imagesPopup = document.createElement('div'),
...
function modals() {
  function bindModals(trigersSelector, modalSelector, closeSelector) {
    var modalClickClose = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "true";
    var btnEngineer = document.querySelectorAll(trigersSelector),
        modals = document.querySelector(modalSelector),
        close = document.querySelector(closeSelector),
        window = document.querySelectorAll('[data-modal]'),
        scroll = calcCroll();
    btnEngineer.forEach(function (btn) {
      btn.addEventListener('click', function (e) {
        ...
        document.body.marginRight = "".concat(scroll, "px");
      });
    });
...
function tabs(parentTabsSel, tabsSel, tabcontentSel, activeClass) {
  ...
  var parent = document.querySelector(parentTabsSel),
  ...
  function hideTab() {
    ...
    tabsSelector.forEach(function (item) {
  ...
  parent.addEventListener('click', function (e) {
    ...
    if (target && (target.classList.contains(tabsSel.replace(/\./, '')) || target.parentNode.classList.contains(tabsSel.replace(/\./, '')))) {
      tabsSelector.forEach(function (item, i) {
...
var timer = function timer(id, dedline) {
  ...
  var getZero = function getZero(time) {
    if (time <= 9 && time >= 0) {
  ...
  function SetTime(selector, endtime) {
    ...
    var timerClock = setInterval(refreshTime, 1000);
    refreshTime();
...
/***/ "./src/js/modules/validateForm.js":
/*!****************************************!*\
  !*** ./src/js/modules/validateForm.js ***!
  \****************************************/
/*! exports provided: default */
...
var validateForm = function validateForm() {
  var modalClickClose = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "true";
  var popupCalcBtn = document.querySelector('.popup_calc_button'),
  ...
  var nextForm = true;
  popupCalcBtn.addEventListener('click', function (e) {
    if (e.target) {
      e.preventDefault();
    }
  ...
  popupCalc.addEventListener('click', function (e) {
